...
\begin{tabular}{@{}rl@{}}
  ...
  5 \texttimes & Blue trim potentiometer with center detent\footnote{Potentiometers with a center detent snap when they are turned through their center position} \\
  9 \texttimes & Blue trim potentiometer without a detent \\
  1 \texttimes & Green D-shaped potentiometer with center detent\footnote{See footnote 1} \\
...
\begin{enumerate}
  ...
  \item Place the 5 green D-shaped potentiometers in ``Green pot''
    footprints. If the big legs are hard to snap in, flatten them with pliers first. Do not solder the legs yet. Use the appropriate potentiometer for the bottom-most place marked as ``Green pot w/ center detent''.
