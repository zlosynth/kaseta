...
other words, the length of the delay. By default, this length is between 10 ms
and 5 minutes. Turning this knob to the maximum while holding the button
switches the range to audio range from 14 Hz to 1.8 kHz.
