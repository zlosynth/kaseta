...
Pass through clean unaffected singal.
...
Main voice followed by three echos in even intervals set through POSITION.
The three echoing heads we placed left and right using PAN. Note that VOL of
each reading head is reduced to avoid compression or clipping.

Increase FEEDBACK of the bottom-most head to produce infinite echo.
...
\subsection{Almost reverb}

\vspace{5mm}\begin{center}\includegraphics[width=0.7\textwidth]{patch-saturation.pdf}\vspace{5mm}\end{center}

Feedback close, low pass set on feedback.
