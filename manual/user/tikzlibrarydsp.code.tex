...
%
% The library has been extended with a stereo flow dspflows by Petr Horacek
% under the terms of CC BY 2.5, 2023.
%
% -------------------------------------------------------------------------
...
\pgfarrowsdeclare{dsparrowmids}{dsparrowmids}
{
	\arrowsize=0.15pt
	\advance\arrowsize by .1\pgflinewidth
	\pgfarrowsleftextend{-5\arrowsize}
	\pgfarrowsrightextend{7\arrowsize}
}
{
	\arrowsize=0.15pt
	\advance\arrowsize by .1\pgflinewidth
	...
	\pgfsetmiterjoin
	\pgfsetbuttcap
	\pgfpathmoveto{\pgfpoint{0}{6.5\arrowsize}}
	\pgfpathlineto{\pgfpoint{16\arrowsize}{0pt}}
	\pgfpathlineto{\pgfpoint{0}{-6.5\arrowsize}}
	\pgfpathclose
	\pgfusepathqfill
}
...
\tikzset{dspsquare/.style={shape=rectangle,draw,align=center,text depth=0.3em,text height=1em,inner sep=3pt,
	line cap=round,line join=round,line width=\dsplinewidth,minimum size=\dspsquareblocksize}}
\tikzset{dspfilter/.style={shape=rectangle,draw,align=center,text depth=0.3em,text height=1em,inner sep=3pt,
...
\tikzset{dspflows/.style={semithick,double,
  decoration={markings,mark=at position 0.5 with {\arrow{dsparrowmids}}},postaction={decorate}}}
